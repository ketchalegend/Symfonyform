 ...
 */
class Hubotfaq extends \App\Entity\Hubotfaq implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Hubotfaq' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Hubotfaq' . "\0" . 'question', '' . "\0" . 'App\\Entity\\Hubotfaq' . "\0" . 'answer', '' . "\0" . 'App\\Entity\\Hubotfaq' . "\0" . 'email'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Hubotfaq $proxy) {
