...
// Returns the private 'App\Repository\HubotfaqRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\HubotfaqRepository.php';

return $this->privates['App\Repository\HubotfaqRepository'] = new \App\Repository\HubotfaqRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
