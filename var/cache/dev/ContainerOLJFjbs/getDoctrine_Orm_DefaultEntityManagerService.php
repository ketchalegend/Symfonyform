...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\HubotfaqRepository' => function () {
    return ($this->privates['App\Repository\HubotfaqRepository'] ?? $this->load('getHubotfaqRepositoryService.php'));
