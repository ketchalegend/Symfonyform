...
class srcDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    private function doMatch(string $rawPathinfo, array &$allow = array(), array &$allowSchemes = array()): ?array
    {
        ...
        switch ($pathinfo) {
            default:
                $routes = array(
                    '/data' => array(array('_route' => 'data', '_controller' => 'App\\Controller\\DataController::data'), null, null, null),
                    '/' => array(array('_route' => 'create', '_controller' => 'App\\Controller\\DataController::home'), null, null, null),
                    '/commands' => array(array('_route' => 'hubot_commands', '_controller' => 'App\\Controller\\HubotCommandsController::hubot_commands'), null, null, null),
                    '/logine' => array(array('_route' => 'login', '_controller' => 'App\\Controller\\LoginController::login'), null, null, null),
        ...
        foreach ($regexList as $offset => $regex) {
            while (preg_match($regex, $matchedPathinfo, $matches)) {
                switch ($m = (int) $matches['MARK']) {
                    default:
                        $routes = array(
                            21 => array(array('_route' => 'edit', '_controller' => 'App\\Controller\\DataController::edit'), array('id'), null, null),
                            44 => array(array('_route' => 'app_data_delete', '_controller' => 'App\\Controller\\DataController::delete'), array('id'), null, null),
                            68 => array(array('_route' => 'security_confirm', '_controller' => 'App\\Controller\\LoginController::confirm'), array('token'), null, null),
